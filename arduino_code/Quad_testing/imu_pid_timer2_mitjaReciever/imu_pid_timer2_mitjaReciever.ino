...
int pid_i_gain_roll = 18;
int pid_d_gain_roll = 0.04;
int pid_p_gain_roll = 1.3;
...
void calculatePID(float pid_pitch_setpoint){
  ...
  //Serial.println(String(pid_i_mem_roll));
  //Serial.println(String(pid_p_gain_roll * pid_error_temp));
