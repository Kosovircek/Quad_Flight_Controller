...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void loop(){
        ...
        ////////////////////////////////// Mitja Comments ///////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////                                                                                      // TO JE THE IMU CODE OD UNIH DVEH VIDEJEV
        //This is the added IMU code from the videos:                                                                                                                                             //#1{
        //https://youtu.be/4BoIE8YQwM8
        //https://youtu.be/j-kE0AMEWy4
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        //Gyro angle calculations                                                                                                                                                                         //GYRO USED TO CALCULATE ANGLE TRAVELED
        //0.0000611 = 1 / (250Hz / 65.5)                                                                                                                                                                   //#2{
        angle_pitch += gyro_pitch * 0.0000611;                                    //Calculate the traveled pitch angle and add this to the angle_pitch variable.
        angle_roll += gyro_roll * 0.0000611;                                      //Calculate the traveled roll angle and add this to the angle_roll variable.

        //0.000001066 = 0.0000611 * (3.142(PI) / 180degr) The Arduino sin function is in radians                                                                                                                     //Couple the roll and pitch to yaw
        angle_pitch -= angle_roll * sin(gyro_yaw * 0.000001066);                  //If the IMU has yawed transfer the roll angle to the pitch angel.
        angle_roll += angle_pitch * sin(gyro_yaw * 0.000001066);                  //If the IMU has yawed transfer the pitch angle to the roll angel.                                                        //}#2

        //Accelerometer angle calculations                                                                                                                                                                //ACCELEROTMETER USED FOR FIXING DRIFT (4% of total angle)
        acc_total_vector = sqrt((acc_x*acc_x)+(acc_y*acc_y)+(acc_z*acc_z));       //Calculate the total accelerometer vector.                                                                              //#3{
        ...
        angle_roll_acc -= 0.0;                                                    //Accelerometer calibration value for roll.                                                                              //}#3
        ...
        //what you get out is +-400ms pulse 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void calculate_pid(){
        //Roll calculations
        pid_error_temp = gyro_roll_input - pid_roll_setpoint; //error between mpu and reciever (0<error<1500?)
